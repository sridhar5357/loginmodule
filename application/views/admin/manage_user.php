...
<p><?php echo anchor('admin/create_user', lang('index_create_user_link'))?> 
	<?php //echo anchor('admin/create_group', lang('index_create_group_link'))?></p>

<p><?php echo anchor('admin/logout','Logout'); ?></p>